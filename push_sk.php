...
for( $i= 0 ; $i <= 1 ; $i++ )
{
		...
		$txt = file_get_contents("http://dam.egat.co.th/line_data/sk_line.txt");
...
echo "<meta http-equiv=\"refresh\" content=\"5;url=https://sirikitdam1.herokuapp.com/push_sk_bb.php\"/>";
?>